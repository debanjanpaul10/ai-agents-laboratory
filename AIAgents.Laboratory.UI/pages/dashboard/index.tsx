...
import DirectChatComponent from "@components/common/direct-chat";
                            ...
                            <div className="flex justify-between items-start mb-8">
                                ...
                                <div className="relative group/button">
                                    ...
                                    <button
                                        ...
                                        className="relative bg-red-500/20 backdrop-blur-sm hover:bg-red-500/30 text-white font-semibold py-2 px-3 md:py-3 md:px-6 rounded-xl border border-red-500/30 hover:border-red-400/50 transition-all duration-300 hover:scale-105 shadow-lg hover:shadow-red-500/25"
                                    >
