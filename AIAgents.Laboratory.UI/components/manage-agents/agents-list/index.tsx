...
export default function AgentsListComponent({
	...
	return (
		<div className="fixed inset-0 w-full h-full max-w-full max-h-full z-[100] bg-gray-900 flex items-center justify-center">
			<div className="w-full h-full md:w-full md:h-full bg-gradient-to-b from-gray-900 via-slate-900 to-black rounded-none md:rounded-2xl shadow-xl overflow-y-auto">
				{/* Header */}
