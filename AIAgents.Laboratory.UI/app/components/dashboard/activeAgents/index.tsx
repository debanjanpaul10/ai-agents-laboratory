...
export default function ActiveAgentsComponent() {
	...
	return (
		<div className="relative group/card">
			<div className="absolute -inset-0.5 bg-gradient-to-r from-blue-500/30 via-blue-600/30 to-cyan-500/30 rounded-2xl blur opacity-50 group-hover/card:opacity-75 transition duration-500"></div>
			<div className="relative bg-gradient-to-br from-gray-800/90 via-gray-900/90 to-black/90 backdrop-blur-xl text-white p-6 rounded-2xl border border-blue-500/20 hover:border-blue-400/40 transition-all duration-500 hover:scale-105 min-h-[280px] flex flex-col shadow-2xl">
				...
				<p className="text-gray-300 text-sm leading-relaxed mb-6 flex-1">
					Monitor your most active AI agents and their current status
					in real-time.
				</p>
