...
export const AssociateApplicationsFlyoutPropsConstants = {
	Headers: {
		Heading: "Associate Application",
		SubHeading: "Select the application this agent belongs to",
	},
	Hints: {
		Search: "Search applications...",
		Info: "Associate this agent with a registered application. The application defines the context and permissions under which this agent operates.",
		NoApplications: "No applications found matching your search.",
	},
	Buttons: {
		Confirm: "Confirm",
		Clear: "Clear selection",
...
export const RegisterApplicationsConstants = {
	...
	Headers: {
		MainHeader: "Registered Applications",
		NewApplicationRegisterButton: "Register New Application",
	},
	DeletePopupDialog: {
		Title: "Delete Registered Application",
		Description:
	...
	RegisterNewApp: {
		...
		SubHeader: "Register an application to enable agent authentication.",
		AzureRegistration: {
			Header: "Azure Registered",
			SubHeader: "This application is registered in Azure AD",
		},
		InfoBox: {
			Header: "Pro Tip",
			Text: "Registering an application allows your AI agents to authenticate and interact with external services on behalf of users. Provide the Azure App Registration GUID if this app is registered in Azure Active Directory.",
		},
	},
};
...
export const NotificationsConstants = {
	...
	MainLoader: "Loading notifications...",
