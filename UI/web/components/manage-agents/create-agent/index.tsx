...
export default function CreateAgentComponent() {
    ...
    const [
        associateApplicationsFlyoutOpen,
        setAssociateApplicationsFlyoutOpen,
    ] = useState<boolean>(false);
    ...
    useEffect(() => {
        if (isDrawerOpen !== IsDrawerOpenStoreData) {
            ...
            if (!IsDrawerOpenStoreData) {
                ...
                setAssociateApplicationsFlyoutOpen(false);
    ...
    const toggleAssociateApplicationsFlyout = (isOpen: boolean) => {
        setAssociateApplicationsFlyoutOpen(isOpen);
    };
                    ...
                    >
                        ...
                        <div className="relative h-full bg-gradient-to-br from-gray-900/95 via-slate-900/95 to-black/95 backdrop-blur-xl border-x border-white/10 shadow-2xl">
                            <AssociateApplicationFlyoutComponent
                                isOpen={associateApplicationsFlyoutOpen}
                                onClose={() =>
                                    toggleAssociateApplicationsFlyout(false)
                                }
                    ...
                    <div className="relative h-full bg-gradient-to-br from-gray-900/95 via-slate-900/95 to-black/95 backdrop-blur-xl border-l border-white/10 shadow-2xl">
                        <CreateAgentFlyoutComponent
                            ...
                            onOpenAssociateApplications={() =>
                                toggleAssociateApplicationsFlyout(true)
                            }
                            onClearApplication={handleClearApplication}
                        />
                    </div>
                </div>
            </>
