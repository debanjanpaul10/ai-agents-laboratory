...
export default function ModifyAgentComponent({
    ...
    function handleEditSave() {
        ...
        form.append("applicationId", editFormData.applicationId.toString());
    ...
    return IsEditAgentDataLoading ? (
        ...
        isEditDrawerOpen && selectedAgent && (
            <div
            ...
            >
                ...
                <div className="flex items-center justify-between p-6 border-b border-white/10 flex-shrink-0">
                    ...
                    <button
                        ...
                        className="p-2 rounded-lg bg-white/5 hover:bg-red-500/20 border border-white/10 hover:border-red-500/30 transition-all duration-200 text-white/70 hover:text-red-400 group"
                        disabled={isDisabled}
                    >
                ...
                <div className="flex-1 overflow-y-auto p-6 space-y-6 min-h-0">
                    ...
                    <div className="space-y-2">
                        ...
                        <textarea
                            ...
                            placeholder={
                                ManageAgentConstants.ModifyAgentConstants
                                    .Placeholders.AgentDescriptionPlaceholder
                            }
                            disabled={
                                isDisabled ||
                                accounts[0].username !== editFormData.createdBy
                    ...
                    <div className="space-y-2">
                        ...
                        <div className="relative group">
                            <div className="absolute -inset-0.5 bg-gradient-to-r from-blue-500/20 to-indigo-500/20 rounded-xl blur opacity-50 group-hover:opacity-75 transition duration-300"></div>
                            <button
                                onClick={onOpenAssociateApplications}
                                disabled={
                                    isDisabled ||
                                    accounts[0].username !==
                                        editFormData.createdBy
                                }
                                className="relative w-full bg-white/5 border border-white/10 hover:border-white/20 hover:border-blue-500/50 rounded-xl p-4 text-left transition-all duration-200 min-h-[48px] flex items-center justify-between disabled:opacity-50 disabled:cursor-not-allowed"
                            >
                                <div className="flex items-center space-x-3">
                                    <Settings className="w-4 h-4 text-blue-400" />
                                    <div>
                                        <span className="text-white font-medium">
                                            {editFormData.applicationId !== 0
