...
export default function CreateAgentFlyoutComponent({
    ...
    function handleSubmit() {
        ...
        form.append("applicationId", formData.applicationId.toString());
                        ...
                        <div className="space-y-2">
                            ...
                            <div className="relative group">
                                ...
                                <button
                                    ...
                                    className="relative w-full bg-white/5 border border-white/10 hover:border-white/20 hover:border-blue-500/50 rounded-xl p-4 text-left transition-all duration-200 min-h-[56px] flex items-center justify-between"
                                >
                                    <div className="flex items-center space-x-3">
