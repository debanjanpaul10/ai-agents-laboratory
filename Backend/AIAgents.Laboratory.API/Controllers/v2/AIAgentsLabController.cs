    ...
    ICommonAiHandler commonAiHandler, IFeedbackHandler feedbackHandler) : BaseController(httpContextAccessor, configuration)
{
    ...
    public ResponseDto GetConfigurationsData()
    {
        ...
        try
        {
            logger.LogAppInformation(
                ...
                nameof(GetConfigurationsData), DateTime.UtcNow,
    ...
    public ResponseDto GetConfigurationByKeyName([FromQuery] string configKey)
    {
        ...
        try
        {
            logger.LogAppInformation(
                LoggingConstants.LogHelperMethodStart,
                nameof(GetConfigurationByKeyName), DateTime.UtcNow,
    ...
    [ProducesResponseType(StatusCodes.Status404NotFound)]
    [SwaggerOperation(
        Summary = AddBugReportDataAction.Summary,
        Description = AddBugReportDataAction.Description,
        OperationId = AddBugReportDataAction.OperationId)]
    public async Task<ResponseDto> AddBugReportDataAsync(
        [FromBody] AddBugReportDTO addBugReport,
    ...
    )
    {
        ...
        try
        {
            logger.LogAppInformation(
                LoggingConstants.LogHelperMethodStart,
                nameof(AddBugReportDataAsync), DateTime.UtcNow,
        ...
        catch (Exception ex)
        {
            logger.LogAppError(
                ex,
                LoggingConstants.LogHelperMethodFailed,
                nameof(AddBugReportDataAsync), DateTime.UtcNow, ex.Message
            );
            throw new AIAgentsBusinessException(
                message: ex.Message,
                correlationId: correlationContext.CorrelationId
    ...
    [ProducesResponseType(StatusCodes.Status404NotFound)]
    [SwaggerOperation(
        Summary = SubmitFeatureRequestDataAction.Summary,
        Description = SubmitFeatureRequestDataAction.Description,
        OperationId = SubmitFeatureRequestDataAction.OperationId)]
    public async Task<ResponseDto> SubmitFeatureRequestDataAsync(
        [FromBody] NewFeatureRequestDTO newFeatureRequest,
        CancellationToken cancellationToken = default
    )
    {
        bool result = false;
        try
        {
            logger.LogAppInformation(
                LoggingConstants.LogHelperMethodStart,
                nameof(SubmitFeatureRequestDataAsync), DateTime.UtcNow,
        ...
        catch (Exception ex)
        {
            logger.LogAppError(
                ex,
                LoggingConstants.LogHelperMethodFailed,
                nameof(SubmitFeatureRequestDataAsync), DateTime.UtcNow, ex.Message
            );
            throw new AIAgentsBusinessException(
                message: ex.Message,
                correlationId: correlationContext.CorrelationId
    ...
    public async Task<ResponseDto> GetTopActiveAgentsDataAsync(CancellationToken cancellationToken = default)
    {
        ...
        try
        {
            logger.LogAppInformation(
                LoggingConstants.LogHelperMethodStart,
                nameof(GetTopActiveAgentsDataAsync), DateTime.UtcNow,
                    JsonConvert.SerializeObject(new { correlationContext.CorrelationId, base.UserEmail })
            );
