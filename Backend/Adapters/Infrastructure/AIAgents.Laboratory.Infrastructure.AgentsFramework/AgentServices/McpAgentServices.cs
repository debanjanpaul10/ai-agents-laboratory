...
public sealed class McpAgentServices(
    ...
    ICorrelationContext correlationContext) : IMcpClientServices
{
    ...
    )
    {
        ...
        catch (Exception ex)
        {
            logger.LogAppError(
                ...
                nameof(GetAllMcpToolsAsync), DateTime.UtcNow, ex.Message
            );
        ...
        string mcpServerUrl, string toolName, Dictionary<string, object?> toolArguments, CancellationToken cancellationToken = default)
    {
        ...
        try
        {
            logger.LogAppInformation(
                LoggingConstants.LogHelperMethodStart,
                nameof(GetMcpToolResponseAsync), DateTime.UtcNow,
        ...
        catch (Exception ex)
        {
            logger.LogAppError(
                ex,
                LoggingConstants.LogHelperMethodFailed, nameof(GetMcpToolResponseAsync), DateTime.UtcNow, ex.Message
            );
            throw new AIAgentsBusinessException(
                message: ex.Message,
                correlationId: correlationContext.CorrelationId
    ...
    )
    {
        ...
        catch (Exception ex)
        {
            logger.LogAppError(
                ex,
                LoggingConstants.LogHelperMethodFailed,
                nameof(CreateMcpClientAsync), DateTime.UtcNow, ex.Message
            );
            throw new AIAgentsBusinessException(
                message: ex.Message,
                correlationId: correlationContext.CorrelationId
