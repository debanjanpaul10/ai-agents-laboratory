...
/// <summary>
/// The <c>Utilities</c> class provides helper methods for processing spreadsheet data, specifically for extracting text from cells and preparing the content of Excel workbooks for use in the knowledge base.
/// </summary>
        ...
        foreach (Sheet sheet in workbookPart.Workbook.Sheets.OfType<Sheet>())
        {
            ...
            foreach (var row in rows)
            {
                ...
                foreach (var cell in row.Elements<Cell>())
                    cellValues.Add(Utilities.GetCellText(cell, sharedStringTable));
